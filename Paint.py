...
class main:
    ...
    def drawWidgets(self):
        ...
        Label(self.controls, text='Largura:',font=('arial 18')).grid(row=0,column=0)
        ...
        colormenu.add_command(label='Cor de Fundo',command=self.change_bg)
        optionmenu = Menu(menu)
        menu.add_cascade(label='Opções',menu=optionmenu)
        optionmenu.add_command(label='Limpar',command=self.clear)
